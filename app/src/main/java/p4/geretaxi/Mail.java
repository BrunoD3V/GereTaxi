...
public class Mail extends javax.mail.Authenticator {
    ...
    public Mail() {
        ...
        _user = "geretaxiapp@gmail.com"; // username
        _pass = "lucky3luke"; // password
        _from = getUserMail(); // email sent from
    ...
    private String getUserMail() {
        ...
        return sharedPreference.getValueString(MyApplication.getAppContext(), Constants.EMAIL);
    }
