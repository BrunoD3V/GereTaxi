package p4.geretaxi.basicandroidkeystore;
...
public class BasicAndroidKeyStoreFragment {
    ...
    public void createKeys(Context context, String key) throws NoSuchProviderException,
        ...
        System.out.println("TAG + Public Key is: " + kp.getPublic().toString());
    ...
    public String signData(String inputStr) throws KeyStoreException,
         ...
         */
        if (entry == null) {
            System.out.println("TAG +No key found under alias: " + mAlias);
            System.out.println("TAG +Exiting signData()...");
            return null;
        }
        ...
        if (!(entry instanceof KeyStore.PrivateKeyEntry)) {
            System.out.println("TAG +Not an instance of a PrivateKeyEntry");
            System.out.println("TAG +Exiting signData()...");
            return null;
        }
    ...
    public boolean verifyData(String input, String signatureStr) throws KeyStoreException,
        ...
        if (signatureStr == null) {
            System.out.println("TAG +Invalid signature.");
            System.out.println("TAG +Exiting verifyData()...");
            return false;
        }
